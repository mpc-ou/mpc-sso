...
const EVENT_OPTIONS = [
  ...
  { value: 'client.updated', label: 'Sửa OAuth client' },
  { value: 'client.deleted', label: 'Xoá OAuth client' },
  { value: 'department.created', label: 'Tạo ban' },
  { value: 'department.updated', label: 'Sửa ban' },
  { value: 'department.deleted', label: 'Xoá ban' },
  { value: 'club-role.created', label: 'Thêm chức vụ' },
  { value: 'club-role.updated', label: 'Sửa chức vụ' },
  { value: 'club-role.deleted', label: 'Xoá chức vụ' },
